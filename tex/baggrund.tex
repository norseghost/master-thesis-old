...
\subsubsection{Erhvervsuddannelse}
...
\subsection{Parliamentariske undersøgelser}\label{sec:review-parl}
...
\subsubsection{Algoritmisk sociologi}\label{sec:review-compsoc}
...
\subsection{Spændinger og tendenser i ungdomsuddannelse i Danmark}
