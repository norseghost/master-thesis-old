...
\section{Problemfelt}\label{sec:problem}
...
For at illustrere dette, er der i det følgende uddrag fra nogle formålsparagraffer for forskellige ungdomsuddannelser \todo{david: Forsøgt en mild beskæring. men det kan godt minimeres mere, eller jeg kan finde en anden ilustration citation}
...
Denne \todo{Hvad for en denne? tydeliggør sortering, legitimering af forskelsbehandling} skules dog af en forståelse af Danmark som et forholdsvist fladt samfund, hvor “alle” har mulighed for at blive “alt”, til trods for, at der dokumenterede forskelle i uddannelsesudfald på baggrund af socioøkonomisk udgangspunkt.\todo{kilde:  det socialt flade danmark}
...
\section{Sortering til ungdomsuddannelserne i dag}
\label{sec:sorting}
...
\section{Problemformulering}\label{sec:pf}
...
Jeg vil også berøre de gymnasiale uddannelser, og hvordan debatten mellem arbjedsmarkedsrelaterede\todo{horribelt ord} kompetencer og såkaldt “overuddannelse” arter sig.
...
\subsection{Undersøgelsesspørgsmål}\label{sec:resqs}
...
\section{Specialets videre opbygning}\label{sec:structure}
